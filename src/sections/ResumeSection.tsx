...
import { FileText, Download, Maximize2, X, ChevronLeft, ChevronRight, ZoomIn, ZoomOut, Search, FileCheck, Award, Target } from 'lucide-react';
import Tilt from 'react-parallax-tilt';
import resumePDF from '@/assets/resume.pdf';

const ResumeSection: React.FC = () => {
  const [isModalOpen, setIsModalOpen] = useState(false);
  const summaryUrl = 'https://drive.google.com/file/d/1_z7etmauoHBmrOUerpTwOxva6G59WwPf/view?usp=sharing';
      ...
      <AnimatePresence>
        {isModalOpen && (
          ...
          >
            ...
            <div className="relative z-[510] flex items-center justify-between px-6 py-4 md:px-10 md:py-6 border-b border-white/5 bg-black/20 backdrop-blur-xl">
               ...
               <div className="flex items-center gap-4">
                  ...
                  <button 
                    ...
                    className="w-10 h-10 md:w-12 md:h-12 rounded-full border border-white/10 flex items-center justify-center bg-white/5 hover:bg-red-500/20 hover:border-red-500/50 hover:text-red-500 transition-all shadow-xl group"
            ...
            <div className="flex-grow overflow-hidden relative bg-black/40">
                ...
                >
                  <iframe
                    src={getEmbedUrl(summaryUrl)}
                    className="w-full h-full max-w-5xl border-none shadow-[0_0_100px_rgba(0,0,0,0.8)]"
                    allow="autoplay"
            ...
            {/* Mobile Action Bar */}
            <div className="md:hidden p-4 border-t border-white/5 bg-black/20 backdrop-blur-xl">
               <button 
                 onClick={handleDownload}
